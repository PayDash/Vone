 ...
 * Modified work Copyright (C) 2026 Vone Contributors
 *
...
private let audioTapLog = OSLog(subsystem: "com.ebullioscopic.Atoll.dynamicisland", category: "AudioTap")
...
class AudioTap: NSObject {
    ...
    private let audioQueue = DispatchQueue(label: "com.ebullioscopic.Atoll.audiotap", qos: .userInitiated)
    ...
    private func startCaptureSync() {
        ...
        let aggregateDict: [String: Any] = [
            kAudioAggregateDeviceNameKey: "Vone_Virtual_Tap",
