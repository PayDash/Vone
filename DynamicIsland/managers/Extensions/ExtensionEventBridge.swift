...
/// Bridges extension payload updates between Vone processes (main app, helpers, XPC services).
...
final class ExtensionEventBridge {
    ...
    private func snapshotURL(for channel: Channel) -> URL {
        ...
        let directory = appSupport.appendingPathComponent("VoneExtensions", isDirectory: true)
        switch channel {
        case .liveActivities:
