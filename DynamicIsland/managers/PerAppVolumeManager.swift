...
private let perAppVolumeLog = OSLog(subsystem: "com.ebullioscopic.Atoll.dynamicisland", category: "PerAppVolume")
...
/// path to the output device -- Vone does not insert itself into the audio of
...
final class PerAppVolumeManager: ObservableObject {
    ...
    func refreshApps() {
        ...
        for processObject in AudioProcessQuery.processObjectIDs() {
            ...
            // Vone's own output would mean tapping ourselves.
