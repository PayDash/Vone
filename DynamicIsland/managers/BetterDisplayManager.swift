...
/// - Observe OSD notifications from BetterDisplay and route them to Vone's HUD pipeline
...
final class BetterDisplayManager: ObservableObject {
    ...
    /// Route a decoded BetterDisplay OSD notification to the active Vone HUD variant.
