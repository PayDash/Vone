...
/// the writer's identity. A native Vone write otherwise removes `apple-tool:` and
...
enum ClaudeKeychainStore {
    ...
    /// Writes and closes stdin without allowing a vanished reader to terminate Vone.
