...
struct CodexQuotaClient {
    private static let log = os.Logger(subsystem: "com.ebullioscopic.Atoll.DynamicIsland", category: "CodexQuota")
    ...
    func fetchLimits() async -> (session: UsageLimit?, week: UsageLimit?) {
        ...
        request.setValue("Vone", forHTTPHeaderField: "User-Agent")
