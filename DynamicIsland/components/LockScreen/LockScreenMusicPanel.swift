...
struct LockScreenMusicPanel: View {
    ...
    private var panelContent: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .voneArtworkWallpaperDismissed)) { _ in
    ...
    private func expandArtworkToFullscreen() {
        ...
        FullScreenArtworkWindowManager.shared.onDismiss = {
            Task { @MainActor in
                withAnimation(.easeInOut(duration: 0.28)) {
                    NotificationCenter.default.post(name: .voneArtworkWallpaperDismissed, object: nil)
                }
            }
        }
...
extension Notification.Name {
    static let voneArtworkWallpaperDismissed = Notification.Name("voneArtworkWallpaperDismissed")
}
