...
final class LocalSendService: NSObject, ObservableObject {
        ...
        for scheme in schemes {
            for path in paths {
                ...
                components.queryItems = [
                    URLQueryItem(name: "fingerprint", value: "vone.localsend.bridge"),
                ]
                ...
                do {
                    ...
                    guard let http = response as? HTTPURLResponse,
                          ...
                          fingerprint != "vone.localsend.bridge"
                    else {
                        continue
                    }
    ...
    private func sendAnnouncement() {
        let payload: [String: Any] = [
            "alias": Host.current().localizedName ?? "Vone",
            "version": "2.1",
            "deviceModel": "Mac",
            "deviceType": "desktop",
            "fingerprint": "vone.localsend.bridge",
            ...
            // when Vone is not serving LocalSend register endpoint.
            "protocol": "http",
            "download": false,
            "announcement": true,
            "announce": true,
    ...
    private func handleIncoming(content: Data, endpoint: NWEndpoint?) {
        ...
        if fingerprint == "vone.localsend.bridge" { return }
