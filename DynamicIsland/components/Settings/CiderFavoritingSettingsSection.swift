    ...
    var body: some View {
        Section {
            ...
            VStack(alignment: .leading, spacing: 6) {
                Text("Playback needs none of this. The Favorite Song control does, because favouriting is not something macOS Now Playing can carry -- Vone has to ask Cider itself.")
