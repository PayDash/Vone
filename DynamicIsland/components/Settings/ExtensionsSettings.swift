...
struct ExtensionsSettingsView: View {
    ...
    private var marketplaceSection: some View {
        Section {
            Link(destination: URL(string: "https://getvone.app/marketplace")!) {
                HStack(spacing: 10) {
    ...
    private var globalTogglesSection: some View {
        Section {
            ...
            if Defaults[.enableThirdPartyExtensions] {
                ...
                Text("Enable extensions to allow third-party apps to display live activities and lock screen widgets in Vone.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
        }
