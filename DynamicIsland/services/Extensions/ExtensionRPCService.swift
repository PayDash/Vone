           ...
           case .array(let filesArray) = filesValue {
            for fileValue in filesArray {
                ...
                let tempDir = FileManager.default.temporaryDirectory
                    .appendingPathComponent("VoneExtensionFiles", isDirectory: true)
