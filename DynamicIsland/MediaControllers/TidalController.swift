...
/// Everything Vone can drive in TIDAL that TIDAL does not otherwise expose,
...
enum TidalAccessibility {
    ...
    /// All of this needs the accessibility permission Vone already asks for
    ...
    private static let accessibilityQueue = DispatchQueue(
        label: "com.ebullioscopic.Atoll.tidal.accessibility",
        qos: .userInitiated
    )
