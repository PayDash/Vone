<p align="center">
	<img src=".github/assets/vone-logo.png" alt="Vone logo" width="100">
</p>

# Contributing to Vone

Thank you for your interest in contributing to Vone! We welcome contributions from everyone—developers, designers, testers, and documentation writers. Please read the following guidelines to help us maintain a collaborative and high-quality project.
...
- **Clone the repo:**
	```bash
	git clone https://github.com/PayDash/Vone.git
	cd Vone
...
Thank you for helping make Vone better!
